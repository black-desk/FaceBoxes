...
SEETA_C_API SeetaFaceDetector *seeta_v6_FaceDetector_new(
  const SeetaModelSetting *setting);

SEETA_C_API void seeta_v6_FaceDetector_delete(const SeetaFaceDetector *object);

SEETA_C_API SeetaFaceDetector *seeta_v6_FaceDetector_clone(
  const SeetaFaceDetector *object);

SEETA_C_API SeetaFaceInfoArray seeta_v6_FaceDetector_detect(
  const SeetaFaceDetector *object, const SeetaImageData *image);

SEETA_C_API void seeta_v6_FaceDetector_set(
  SeetaFaceDetector             *object,
  seeta_v6_FaceDetector_Property property,
  double                         value);

SEETA_C_API double seeta_v6_FaceDetector_get(
  const SeetaFaceDetector *object, seeta_v6_FaceDetector_Property property);
